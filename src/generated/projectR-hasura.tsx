...
/** columns and relationships of "account" */
export type AccountOrganizations_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Organization_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Organization_Order_By>>;
...
export type GetResumesQuery = { __typename?: 'query_root', resume: Array<{ __typename?: 'resume', date_create: any, desired_salary?: number | null, job_position: string, kids?: boolean | null, relocate?: boolean | null, status?: boolean | null, resume_id: string, name_resume: string, short_description?: string | null, jobseeker: { __typename?: 'jobseeker', lastName: string, middleName: string, name: string, phone?: string | null, email?: string | null, gender?: string | null, dateBirth?: any | null, citizenship?: string | null, jobseeker_id: string, work_experiences: Array<{ __typename?: 'work_experience', date_of_dismissal: any, date_of_employment: any, job_position: string, organization: string, work_experience_id: string, short_description: string }> }, jobseeker_educations: Array<{ __typename?: 'jobseeker_education', education_form: string, end_date?: any | null, faculity: string, group: string, short_description?: string | null, speciality: string, start_date?: any | null }>, work_experiences: Array<{ __typename?: 'work_experience', date_of_dismissal: any, date_of_employment: any, job_position: string, organization: string, short_description: string, work_experience_id: string }>, city_of_residence?: { __typename?: 'city_of_residence', address?: string | null, city: string, city_of_residence_id: string, postal_code?: number | null, region: string, country: string } | null }> };
...
export type InsertResumeMutation = { __typename?: 'mutation_root', insert_resume_one?: { __typename?: 'resume', resume_id: string, relocate?: boolean | null, jobseeker_id: string, kids?: boolean | null, job_position: string, desired_salary?: number | null } | null };
...
export const InsertResumeDocument = gql`
    mutation InsertResume($jobseeker_id: uuid = "", $desired_salary: Int!, $job_position: String = "", $kids: Boolean = false, $relocate: Boolean = false, $status: Boolean = false) {
  insert_resume_one(
    object: {kids: $kids, relocate: $relocate, job_position: $job_position, desired_salary: $desired_salary, jobseeker_id: $jobseeker_id}
  ) {
    resume_id
    relocate
    jobseeker_id
 ...
 *      desired_salary: // value for 'desired_salary'
 *      job_position: // value for 'job_position'
 *      kids: // value for 'kids'
 *      relocate: // value for 'relocate'
